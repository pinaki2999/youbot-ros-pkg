...
#include "algorithm/filtering/ColorBasedROIExtractorRGB.h"
...
private:
	 ...
	 */
	BRICS_3D::ColorBasedROIExtractorRGB rgbBasedRoiExtractor;
...
public:
	 ...
	 *
	 */
	void initializeLimits(int redLimit, int greenLimit, int blueLimit, float distanceThresholdMinimum, float distanceThresholdMaximum);
