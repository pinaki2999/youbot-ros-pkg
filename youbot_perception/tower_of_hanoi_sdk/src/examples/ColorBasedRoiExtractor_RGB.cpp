...
#include "ColorBasedRoiExtractor_RGB.h"
...
void ColorBasedRoiExtractor::initializeLimits(int redLimit, int greenLimit, int blueLimit, float distanceThresholdMinimum, float distanceThresholdMaximum){
	this->rgbBasedRoiExtractor.setRed(redLimit);
	this->rgbBasedRoiExtractor.setBlue(blueLimit);
	this->rgbBasedRoiExtractor.setGreen(greenLimit);
	this->rgbBasedRoiExtractor.setDistanceThresholdMinimum(distanceThresholdMinimum);
	this->rgbBasedRoiExtractor.setDistanceThresholdMaximum(distanceThresholdMaximum);
	this->noOfFramesProcessed=0;
}
...
//	ROS_INFO("\ntransferred kinect_raw message successfully...... :)");
	...
	rgbBasedRoiExtractor.extractColorBasedROI(in_cloud, extracted_cloud);
